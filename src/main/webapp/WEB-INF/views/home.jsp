      ...
      <nav>
        <div class="main-nav container">
          <ul>
            ...
            <li><a href="user/user.html">Tax payment</a></li>
          </ul>
          <div class="login">
            <ul>
          ...
          <div class="seprate">
            <div class="left-panel">
               <div class="left-link">
                  ...
                  <a style="text-decoration:none" href="user/user.html"><i class="fas fa-coins"></i>Tax Payment</a>
            ...
            <div class="remain-panel right-content">
              <div class="short-desc">
                <img src="${pageContext.request.contextPath}/resources/assests/imgs/back.png" alt="back">
                  ...
                  <div class="sub-btn">
                      <button type="submit"><a href="user/user.html">Try it Now!</a></button>
                  </div>
                </div>
                  <div class="long-desc">
