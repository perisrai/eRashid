...
<body>
    ...
    <spring:form action="registervehicle" method="post"  modelAttribute="vehicle">
            ...
            <div id="accordion">
                ...
                <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse" data-parent="#accordion" aria-labelledby="headingTwo">
                        ...
                        <div class="form-input">
                            <spring:input type="text" path="owner.email" class="input"/>
                               ...
                               <span class="focus-input" data-placeholder="Mobile Number"></span>
                                       ...
                                       <div class="form-input">
                                        ...
                                        <div class="form-input">
                                         ...
                                         <div class="form-input">
                                                <spring:input type="text" path="owner.password" class="input"/>
