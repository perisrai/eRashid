  ...
  crossorigin="anonymous"></script>
            ...
            <nav>
                <div class="main-nav container">
                    <ul>
                        ...
                        <li><a href="registerByVehicletype">Registration</a></li>
    ...
    <section class="vehicle-detail">
            <div class="container">
              ...
              <input class="form-control mr-sm-2" name="vno" type="search" width="800px" placeholder="Search" aria-label="Search"><br/>
